...
class ViewController: UIViewController {
    ...
    //MARK: Show message of Game status
    ...
    //MARK: Play sound while tap on object
    func playSound() {
    ...
    //MARK: Calculate distance between object and camera
